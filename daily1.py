...
list1 = [1,2,3,4,5,'a','Karthik',"Mathiyalagan",True]  #list type of object with data
...
list2
list2.count('f')
len(list2) #length of the list
dir(list) #functions which can be operated on list of DS
sorted(list2)

#%% to draw horizontal line
#tuple -also a list type but in tuple multiple type of objects like list, immutable: ( round brackets) : no changes
tuple1 = (1, 2, 'a', 'b')
tuple1
type(tuple1)
type(list2)
...
#%% { curly bracket, comma}
#Set - ordered collection of simple items, immutable. unique elements, and data are sorted
...
for i in list1:    print('Karthik', i + 6)
